...
Before publishing, exercise fresh install, clean-break upgrade, extension and fallback shortcut paths, record/transcribe/paste, cancellation from every adapter, settings/preview launch, uninstall, and purge in a clean supported Ubuntu/GNOME environment.
